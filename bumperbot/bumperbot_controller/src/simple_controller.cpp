    ...
    : Node(name)
{
    ...
    vel_sub_ = create_subscription<geometry_msgs::msg::TwistStamped>("bumperbot_controller/cmd_vel", 10, std::bind(&SimpleController::velCallback, this, std::placeholders::_1));
